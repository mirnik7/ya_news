...
# Импортируем класс модели новостей и комментария
...
class TestRoutes(TestCase):
    ...
    def test_detail_page(self):
        ...
        # Можно и так url = reverse('news:detail', args=(self.news.id,))
        response = self.client.get(url)
        self.assertEqual(response.status_code, HTTPStatus.OK)

    # Ниже тест повторяет два верхних
